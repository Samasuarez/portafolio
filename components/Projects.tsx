...
const projects: Project[] = [
  ...
  {
    name: "Frontend Reflex",
    description: "App web con Reflex",
    long: "Aplicación web desarrollada con Reflex, framework Python para construir interfaces modernas sin JavaScript. Frontend y backend en un solo lenguaje.",
    tags: ["Python", "Reflex", "CSS"],
    live: "https://frontend-silver-wood.reflex.run/",
    github: null,
    featured: false,
  ...
  },
  {
    ...
    long: "Sitio web de películas con diseño atractivo, listado de films y detalle de cada título. Interfaz limpia y experiencia de usuario fluida.",
    tags: ["Next.js", "React", "Tailwind CSS"],
    live: "https://film-page-flax.vercel.app/",
    github: null,
    featured: false,
